...
# Set page config
st.set_page_config(page_title="Wildfire Prediction Chatbot", page_icon="🔥", layout="wide")
...
# Title
st.title("🔥 Wildfire Prediction Chatbot")

# Initialize session state to track processed questions
...
# Input
user_question = st.text_input("Ask a wildfire prediction or analysis question:")
...
def extract_location_data(df):
    ...
    if location_columns:
        # Updated California county and city centroids with precise coordinates
        ca_counties = {
            # Counties
            ...
            # Major Cities (precise coordinates)
            ...
            'central coast': (35.6591, -121.1351),
            'eastern sierra': (37.9375, -118.8574),
            'north coast': (40.7450, -123.8695),
            'far north': (41.3148, -122.3046),
            'inland empire': (34.0635, -117.6508),
            'sacramento valley': (38.7646, -121.2646),
            'san joaquin valley': (36.6066, -120.0568),
            ...
            'angeles': (34.3207, -118.2252),  # Angeles National Forest
            'san bernardino forest': (34.1083, -117.2898),  # San Bernardino National Forest
            'cleveland forest': (32.8242, -116.7762),  # Cleveland National Forest
            'los padres': (35.1344, -120.1965),  # Los Padres National Forest
            'shasta-trinity': (41.0530, -122.3152),  # Shasta-Trinity National Forest
            'tahoe forest': (39.0968, -120.0324),  # Tahoe National Forest
            'el dorado forest': (38.7798, -120.5228),  # El Dorado National Forest
            'inyo forest': (36.5616, -117.4119),  # Inyo National Forest
            'sierra forest': (37.5069, -119.5856),  # Sierra National Forest
            'stanislaus forest': (38.1484, -120.1965),  # Stanislaus National Forest
            'klamath': (41.5044, -123.1090),  # Klamath National Forest
            'lassen forest': (40.4963, -121.5072),  # Lassen National Forest
            'plumas forest': (40.0024, -120.8039),  # Plumas National Forest
            'mendocino forest': (39.7062, -123.0650),  # Mendocino National Forest
            'modoc forest': (41.3835, -121.0460)  # Modoc National Forest
        }
...
# Function to format time info for display
...
# Only process the query if it's new or hasn't been processed yet
...
# Display the results if we have a current question
if st.session_state.current_question:
    ...
    # Show download options in the second column
    with col2:
        ...
        if st.session_state.excel_data:
            ...
            st.download_button(
                ...
                key='download_button'  # Add a unique key
            )
